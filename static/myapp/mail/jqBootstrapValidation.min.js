!(function (a) {
  var e = [],
    t = {
      options: {
        prependExistingSignUpBlock: !1,
        sniffHtml: !0,
        preventSubmit: !0,
        submitError: !1,
        submitSuccess: !1,
        semanticallyStrict: !1,
        autoAdd: { SignUpBlocks: !0 },
        filter: function () {
          return !0;
        },
      },
          ...
          return (
            ...
            this.each(function () {
              var t = a(this),
                ...
                l = o.find(".SignUp-block").first(),
                s = t.parents("form").first(),
                d = [];
              if (
                (!l.length &&
                  r.options.autoAdd &&
                  r.options.autoAdd.SignUpBlocks &&
                  ((l = a('<div class="SignUp-block" />')),
                      ...
                      (c = a.unique(c.sort())).length
                        ? (o.removeClass("success error").addClass("warning"),
                          r.options.semanticallyStrict && 1 === c.length
                            ? l.html(
                                c[0] +
                                  (r.options.prependExistingSignUpBlock
                                    ? l.data("original-contents")
                                    : "")
                              )
                            : l.html(
